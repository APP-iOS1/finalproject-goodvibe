...
//
//    @State var filters = [
//        FilterItem(title: "음란성, 욕설등 부적절한 내용", checked: false),
//        FilterItem(title: "부적절한 홍보 또는 광고", checked: false),
//        FilterItem(title: "주문과 관련없는 사진 게시", checked: false),
//        FilterItem(title: "개인정보 유출 위험", checked: false),
//        FilterItem(title: "리뷰 작성 취지에 맞지 않는 애용(복사글 등)", checked: false),
//        FilterItem(title: "저작권 도용 의심(사진 등)", checked: false),
//        FilterItem(title: "음란성, 욕설등 부적절한 내용", checked: false),
//    ]
//
...
//                        CardView(filter: filter, reportEnter:$reportEnter)
//
//                    }
//                    Button(action:{
//                        reportEnter.toggle()
...
//                            .bold()
//                    }
//                    .background(filters.checked == true ? Color("AccentColor") : Color("lightGray"))
//                    .clipShape(Capsule())
//                    .disabled(filters.checked == true ? false : true)
//
//
//                }
//                .padding()
...
//    private var reportInfoText: some View{
//        VStack(alignment: .leading){
//            HStack{
//                Text("리뷰를 신고하는")
//
